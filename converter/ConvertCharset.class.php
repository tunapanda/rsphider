...
This is not the original ConvertCharset.class.php as developed by Mikolaj Jedrzejak.
This file is modified [Tec] for proper cooperation with Sphider-plus.

************************************************************************/

$PATH_TO_CLASS = dirname(preg_replace("/\\\\/", "/", __FILE__)) . "/" . "charsets" . "/";
