 ...
 *
 *  Adapted for Sphider-plus application by Rolf Kellner [Tec] March. 2010
 *
 * o------------------------------------------------------------------------------o */
        ...
        function read($sFileName){
            ...
            if($res === false) {
                ...
                if($this->_ole->error == 1) {
                    // bad file
                    //die('TOTAL-ERROR. The file ' . $sFileName . ' is not readable');
                }
                $res = "TOTAL-.-ERROR. The file ' . $sFileName . 'is not readable'";
                return ($res);
